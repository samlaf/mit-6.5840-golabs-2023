...
func TestReElection2A(t *testing.T) {
	...
	log.Printf("\033[35m Disconnecting leader %d.\033[0m", leader1)
	...
	log.Printf("\033[35m Reconnecting leader %d.\033[0m", leader1)
	cfg.connect(leader1)
	leader2 := cfg.checkOneLeader()

	// if there's no quorum, no new leader should
	// be elected.
	otherServer := (leader2 + 1) % servers
	log.Printf("\033[35m Disconnecting leader %d and other server %d.\033[0m", leader2, otherServer)
	cfg.disconnect(leader2)
	cfg.disconnect(otherServer)
	time.Sleep(2 * RaftElectionTimeout)
	...
	log.Printf("\033[35m Reconnecting other server %d.\033[0m", otherServer)
	cfg.connect(otherServer)
	cfg.checkOneLeader()
